...
R code to produce all figures for South et al. (in press, 2019) The role of windows of selection and windows of dominance in the evolution of insecticide resistance in human disease vectors. Evolutionary Applications.

Knit this file to produce all figures as tiffs in wosfigs folder.
...
```{r development packages, include=FALSE}
